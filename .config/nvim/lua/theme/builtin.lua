...
function M.get_groups(p)
    return {
        ...
        LineNr = {fg = p.bg5, bg = nil}, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
        ...
        CursorLineNr = {fg = p.grey1, bg = p.bg1}, -- Like LineNr when 'cursorline' is set and 'cursorlineopt' contains "number" or is "both", for the cursor line.
        ...
        MatchParen = {fg = nil, bg = p.bg4}, -- Character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
        ...
        MsgSeparator = { fg=nil, bg=nil },   -- Separator for scrolled messages |msgsep|.
        ...
        -- FloatTitle = {fg = p.orange, bg = p.bg3, bold}, -- Title of floating windows.
        -- -- FloatFooter = { fg=nil, bg=nil },   -- Footer of floating windows.
        -- NormalNC = {fg = p.fg0, bg = nil}, -- Normal text in non-current windows.
        -- Pmenu = {fg = p.fg1, p.bg3}, -- Popup menu: Normal item.
        -- PmenuSel = {fg = p.bg3, p.bg_green}, -- Popup menu: Selected item.
        -- PmenuKind = {fg = p.green, p.bg3}, -- Popup menu: Normal item "kind".
        ...
        -- VisualNOS = {fg = nil, bg = p.bg3}, -- Visual mode selection when vim is "Not Owning the Selection".
