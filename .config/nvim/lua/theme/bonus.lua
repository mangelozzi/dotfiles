...
function M.get_groups(p)
    return {
        ...
        -- LSP / Diagnostics
        DiagnosticError = { fg = p.red, nocombine = true },
        DiagnosticWarn  = { fg = p.yellow, nocombine = true },
        DiagnosticInfo  = { fg = p.blue, nocombine = true },
        DiagnosticHint  = { fg = p.green, nocombine = true },
        DiagnosticFloatingError = { fg = "#ff7070", bg = p.bg3, nocombine = true },
        DiagnosticFloatingWarn  = { fg = "#ffff80", bg = p.bg3, nocombine = true },
        DiagnosticFloatingInfo  = { fg = "#90d0ff", bg = p.bg3, nocombine = true },
        DiagnosticFloatingHint  = { fg = "#90ff90", bg = p.bg3, nocombine = true },
        DiagnosticVirtualTextError = { fg = "#ff7070", bg = p.bg_diff_red, nocombine = true },
        DiagnosticVirtualTextWarn  = { fg = "#ffff80", bg = p.bg_visual_yellow, nocombine = true },
        DiagnosticVirtualTextInfo  = { fg = "#90d0ff", bg = p.bg_diff_blue, nocombine = true },
        DiagnosticVirtualTextHint  = { fg = "#90ff90", bg = p.bg_diff_green, nocombine = true },
